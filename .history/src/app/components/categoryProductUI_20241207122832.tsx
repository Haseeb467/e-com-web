                    ...
                    {products.length > productsPerPage && (
                        <div className="flex justify-center items-center mt-5 space-x-3">
                            <button
                                ...
                                className={`cursor-pointer transition-colors duration-500   text-black p-2 rounded-full ${currentPage === 1
                            ...
                            <button
                                ...
                                className={`cursor-pointer transition-colors duration-500   text-black p-2 rounded-full ${currentPage === totalPages
                                        ? "bg-gray-300 cursor-not-allowed hover:bg-gray-400"
                                        : "bg-black bg-opacity-50 hover:bg-opacity-100"
                                    }`}
                            >
