...
export default function Sidebar() {
    ...
    return (
        <div className="block lg:hidden">
            {/* Navbar */}
            <div
                className={`flex items-center justify-between py-2 ${isOpen ? "bg-white shadow-lg backdrop-blur-lg backdrop-filter" : ""
            ...
            {/* Full-Screen Sidebar */}
            <div
                className={`fixed bottom-0 right-0 top-0 h-screen w-full transform bg-white text-black backdrop-filter ${isOpen ? "translate-x-0" : "translate-x-full"
